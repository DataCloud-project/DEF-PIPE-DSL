...
EdgeProvider TelluGateway0 {
	providerLocation: 'Patienthome0'
	mappingLocation: 'mappingHome'
	
}
CloudProvider TelluCloudProvider {
	providerLocation: 'Oslo'
	mappingLocation: 'mappingCity'
}
