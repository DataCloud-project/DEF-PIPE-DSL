...
/**
 * This is the item provider adapter for a {@link se.kth.datacloud.dsl.ControlParameters.PreCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PreConditionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PreCondition_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PreCondition_type_feature", "_UI_PreCondition_type"),
				 ControlParametersPackage.Literals.PRE_CONDITION__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ControlParametersPackage.Literals.PRE_CONDITION__CONDITION_STEP_LIST);
		}
	...
	public String getText(Object object) {
		LogicalOperatorType labelValue = ((PreCondition)object).getType();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ControlParametersPackage.Literals.PRE_CONDITION__CONDITION_STEP_LIST,
				 ControlParametersFactory.eINSTANCE.createConditionStepPair()));
	}
