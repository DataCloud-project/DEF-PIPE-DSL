...
/**
 * This is the item provider adapter for a {@link se.kth.datacloud.dsl.ExecutionRequirements.Metric} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetricItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addValueDirectionPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExecutionRequirementsPackage.Literals.METRIC__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Value Direction feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addValueDirectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Metric_valueDirection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Metric_valueDirection_feature", "_UI_Metric_type"),
				 ExecutionRequirementsPackage.Literals.METRIC__VALUE_DIRECTION,
				 true,
				 false,
				 false,
	...
	protected void addIsVariablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Metric_isVariable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Metric_isVariable_feature", "_UI_Metric_type"),
				 ExecutionRequirementsPackage.Literals.METRIC__IS_VARIABLE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Metric)object).getDescription();
