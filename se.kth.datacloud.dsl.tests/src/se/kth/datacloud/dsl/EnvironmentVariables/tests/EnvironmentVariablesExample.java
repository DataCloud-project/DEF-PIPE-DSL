...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>EnvironmentVariables</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EnvironmentVariablesExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(EnvironmentVariablesPackage.eNS_URI, 
			 EnvironmentVariablesPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.environmentvariables"));
				EnvironmentVariable root = EnvironmentVariablesFactory.eINSTANCE.createEnvironmentVariable();
