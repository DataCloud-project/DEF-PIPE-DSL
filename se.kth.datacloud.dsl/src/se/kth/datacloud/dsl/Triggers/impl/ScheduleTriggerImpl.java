 ...
 * </p>
 * <ul>
 *   <li>{@link se.kth.datacloud.dsl.Triggers.impl.ScheduleTriggerImpl#getStartTime <em>Start Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScheduleTriggerImpl extends TriggerImpl implements ScheduleTrigger {
	...
	protected EClass eStaticClass() {
		return TriggersPackage.Literals.SCHEDULE_TRIGGER;
	}
	...
	public void setStartTime(String newStartTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TriggersPackage.SCHEDULE_TRIGGER__START_TIME, oldStartTime, startTime));
	}
